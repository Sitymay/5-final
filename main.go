...
// Общие константы для вычислений. Красавчик ( для теста)
const (
...
func (t Training) TrainingInfo() InfoMessage {
	...
	return InfoMessage{
		...
		Calories:     t.Calories(),   // количество потраченных калорий
	}
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	...
	return InfoMessage{
		...
		Calories:     s.Calories(),   // количество потраченных калорий
	}
}
